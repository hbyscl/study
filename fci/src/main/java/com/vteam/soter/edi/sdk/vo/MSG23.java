...
public static class Seller{
    @Rule(status = STATUS.M,format = "AN..35",codelist = "FSBC:SellerNrList")
    ...
    @Rule(status = STATUS.C,format = "AN..35",codelist = "FSBC:SellerNameList")
...
public static class Buyer{
    @Rule(status = STATUS.M,format = "AN..35",codelist = "FSBC:BuyerNrList")
    ...
    @Rule(status = STATUS.C,format = "AN..35",codelist = "FSBC:BuyerNameList")
