...
public class MSG64 extends MSG{
...
public static class PODetails{
    ...
    @Rule(status = STATUS.M,format = "codelist")
    private String AcknowledgementReq;
    public void setAcknowledgementReq(String AcknowledgementReq){
        this.AcknowledgementReq=AcknowledgementReq;
    }
    public String getAcknowledgementReq(){
