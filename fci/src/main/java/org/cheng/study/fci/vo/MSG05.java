...
public class MSG05 extends MSG{
...
public static class Buyer{
    ...
    @Rule(status = STATUS.M,format = "AN2",codelist = CODELIST.Country)
    ...
    @Rule(status = STATUS.M,format = "N..3",codelist = CODELIST.DirectContactAllowed)
...
public static class CreditCoverDetails{
    @Rule(status = STATUS.M,format = "N..3",codelist = CODELIST.Request)
    ...
    @Rule(status = STATUS.C,format = "YYYY-MM-DD")
    private String LateShipmDate;
    public void setLateShipmDate(String LateShipmDate){
        this.LateShipmDate=LateShipmDate;
    }
    public String getLateShipmDate(){
        return this.LateShipmDate;
    }
