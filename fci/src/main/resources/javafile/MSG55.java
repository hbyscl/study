...
public class MSG55 extends MSG{
...
public static class PreShipmentCreditCoverDetails{
    ...
    @Rule(status = STATUS.M,format = "codelist")
    private String PurchaseOrderCreditCoverLossSharing;
    public void setPurchaseOrderCreditCoverLossSharing(String PurchaseOrderCreditCoverLossSharing){
        this.PurchaseOrderCreditCoverLossSharing=PurchaseOrderCreditCoverLossSharing;
    }
    public String getPurchaseOrderCreditCoverLossSharing(){
        return this.PurchaseOrderCreditCoverLossSharing;
    }
