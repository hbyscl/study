...
public static class PmtDetails{
    ...
    @Rule(status = STATUS.C,format = "N14.2{amount}")
    private String RiskSharingDeducAmt;
    public void setRiskSharingDeducAmt(String RiskSharingDeducAmt){
        this.RiskSharingDeducAmt=RiskSharingDeducAmt;
    }
    public String getRiskSharingDeducAmt(){
        return this.RiskSharingDeducAmt;
    }
