...
public class MSG11 extends MSG{
...
public static class PmtDetails{
    ...
    @Rule(status = STATUS.M,format = "N..3",codelist = CODELIST.DocumentPaid)
    ...
    @Rule(status = STATUS.M,format = "N..3",codelist = CODELIST.PaymentType)
